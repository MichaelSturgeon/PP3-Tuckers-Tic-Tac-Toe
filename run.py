...
def game_instructions():
    ...
    time.sleep(4)
    os.system('clear')
    render_cowboy("1. Players take turns marking an empty cell!")
    time.sleep(4)
    os.system('clear')
...
def check_winner():
    ...
    for i in range(len(COMBOS)):
        ...
        if CELL_A == CELL_B and CELL_B == CELL_C:
            render_board()
            render_cowboy(f"The jig is up, {current_player} won this round!!!")
            time.sleep(4)
            os.system('clear')
            replay_game()
...
def check_tie():
    ...
    if board_full:
        render_board()
        render_cowboy("This round ends in a tie!!!")
        time.sleep(4)
        os.system('clear')
        replay_game()
...
def replay_game():
    ...
    if answer == 'y':
        ...
        os.system('clear')
        render_cowboy("Until we meet again!")
        time.sleep(2)
        sys.exit()
    else:
        os.system('clear')
